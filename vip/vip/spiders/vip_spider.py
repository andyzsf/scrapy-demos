...
class vipSpider(CrawlSpider):
	...
	def parse_vip(self,response):
		...
		for site in sites:
			...
			item['image_url']=site.xpath('//li[@style="width: 224px; display: table-cell; vertical-align: top;"]//img[@src][1]').re(r'src=(.*?) data')
			item['price']=site.xpath('//span[@class="u-detail-price"]/text()').extract()
